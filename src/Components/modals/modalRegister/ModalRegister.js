...
import { toggleRegisterWindowModal, toggleModalWindowLogin, callSnackbar } from '../../../reducers/interactive'
        ...
        <DialogContent>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="form-line">
                    <label className="form-label" htmlFor="username">Имя пользователя:<sup>*</sup></label>
                    <input className="form-input" placeholder="Имя пользователя" name="username"
                    {...register('username', {
                ...
                <div className="form-line">
                    <label className="form-label" htmlFor="name">Ваше имя:<sup>*</sup></label>
                    <input className="form-input" placeholder="Ваше имя" name="name" 
                    {...register('name', {
                ...
                <div className="form-line">
                    <label className="form-label" htmlFor="surname">Ваша фамилия:</label>
                    <input className="form-input" placeholder="Фамилия" name="surname" 
                    {...register('surname', {
                ...
                <div className="form-line">
                    <label className="form-label" htmlFor="birthday">Дата рождения:<sup>*</sup></label>
                    <input type='date' className="form-input" placeholder="Дата рождения" name="birthday" 
                    {...register('birthday', {
                ...
                <div className="form-line">
                    <label className="form-label" htmlFor="password1">Придумайте пароль:<sup>*</sup></label>
                    <input type='password' className="form-input" placeholder="Пароль" name="password1" 
                    {...register('password1', {
                        minLength: 8
                    })}/>
                </div>
                <p className="helper-text">{errors.password1?.type === 'minLength'? 'Минимум 8 символов' : ''}</p>
                <div className="form-line">
                    <label className="form-label" htmlFor="password2">Повторите пароль:<sup>*</sup></label>
                    <input type='password' className="form-input" placeholder="Повторите пароль" name="password2" minLength={4} 
                    {...register('password2', {
                        minLength: 8
                    })}/>
                </div>
