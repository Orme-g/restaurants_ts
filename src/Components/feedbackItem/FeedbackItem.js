...
const FeedbackItem = () => {
    ...
    const feedbackList = restaurantReviews.map(
        ({ name, avatar, like, dislike, rating, _id }) => {
            return (
                <div className="feedback-card__container" key={_id}>
                    <div className="feedback-card__header">
                        ...
                        <div className="feedback-card__header_user">
                            <div className="feedback-card__header_username">
                                {name}
                            </div>
                    ...
                    <div className="feedback-card__body">
                        <div className="feedback-card__body_title">
                            Понравилось:
                        </div>
